...
@app.route('/health')
def health():
    return jsonify({"status":"ok","service":"flask-api","version":"2.1","time":str(datetime.datetime.now())})
...
<div class="sc"><div class="num" style="color:#a855f7">2.1</div><div class="lbl">Version</div></div>
